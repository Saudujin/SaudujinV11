...
const FeaturesSection: React.FC = () => {
  ...
  return (
    <div className={`py-16 bg-white dark:bg-gray-900 ${locale === 'ar' ? 'rtl' : 'ltr'}`}>
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {features.map((feature) => (
            <Card key={feature.id} variant="glass" className="transform transition-all duration-300 hover:scale-105">
